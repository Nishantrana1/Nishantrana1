...
🌟 About Me
🔭 Currently working on full-stack applications, creative Python projects, and game development in Unity.
🌱 Actively exploring Python, Unity (C#), Machine Learning, and Embedded Systems (Arduino).
...
Flask, OpenCV, Pygame, Pandas, NumPy, Matplotlib, MediaPipe, DeepFace

🎮 Game Development
Unity (2D/3D), C#, Blender (basics), Game Mechanics Design

📊 Data & Automation
JSON, Git/GitHub

🤖 Hardware & Robotics
Arduino Uno, Sensors, Motor Drivers, Bluetooth Modules, Tera Term Control

📈 Highlighted Projects
Gender Classification App: Real-time gender detection using DeepFace and MediaPipe.

Creative Unity Game: A vertical platformer featuring a jumping car with physics-based mechanics.

Python Contact Manager: JSON-powered contact management with search and update features.
